	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="page-frame">
			...
			<div class="mobile-header">
					...
					<a class="page-logo" href="#"><img src="http://www.qandc.com/img/QC-logo-sm.png" alt="Q&amp;C Hotel Bar" /></a>
					<a class="number" href="#">1 (866) 247-7936</a>
					...
					<div class="mobile-nav-frame">
				        ...
				        <li><a href="/calendar.php">CALENDAR</a></li>
								<li><a href="/business-travel.php">BUSINESS TRAVEL</a></li>
								<li><a href="/new-orleans-event-venues.php">EVENT VENUES</a>
									<ul>
										<li><a href="/new-orleans-wedding-venue.php">Weddings</a></li>
										<li><a href="/room-blocks.php">Room Blocks</a></li>
				                    </ul>
